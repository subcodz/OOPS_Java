...
class Employee{
    ...
    public void printDetails(String name){                  //different parameters, same method name
        System.out.println("Employee name: " + name);
    }

    public void printDetails(int salary){                   //different parameters, same method name
        System.out.println("Employee salary: " + salary);
    }

    public void printDetails(String name, int salary){       //different parameters, same method name
...
/*Function overriding in abstraction */